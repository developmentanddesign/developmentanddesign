...
if(isset($_POST['submit'])){
		if($_POST['title']==""){$_POST['title']="Privacy Policies";}
		if($_POST['desc']=="")
		{
      ...
      <div class="col-xs-12">
          <div class="box box-info">
              <div class="box-header with-border">
                <h3 class="box-title">Add Privacy Policies Page Details</h3>
              </div>
              <!-- /.box-header -->
              <!-- form start -->
                ...
                <div class="box-body">
                    ...
                    <div class="col-sm-6">
    					<div Class="form-group">
    						...
    						<input type="text" name="title" id="title" value="Privacy Policies" disabled title="Already Field" class="form-control"  required>
    					</div>
    					<div Class="form-group">
