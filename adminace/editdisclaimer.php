...
if(isset($_POST['submit'])){
		if($_POST['title']==""){$_POST['title']="Dislaimer";}
		if($_POST['desc']=="")
		{
      ...
      <div class="col-xs-12">
          <div class="box box-info">
              <div class="box-header with-border">
                <h3 class="box-title">Update Disclaimer Page Details</h3>
              </div>
              <!-- /.box-header -->
              <!-- form start -->
              <form action="#" method="POST" enctype="multipart/form-data">
                <div class="box-body">
                     ...
                     <?php $id=$_GET['id']; 
                        $q="select * from disclaimer where id=$id";
                    ...
                    <div class="col-sm-6">
    					<div Class="form-group">
    						...
    						<input type="text" name="title" id="title" value="Disclaimer" disabled title="Already Filled" class="form-control"  required>
    					</div>
    					<div Class="form-group">
