                ...
                <div class="box-body">
    				...
    				<div class="col-sm-6">
    					<div Class="form-group">
    						...
    						<input type="text" name="mtitle" id="mtitle" value=""  class="form-control"  required>
    					</div>
    					<div Class="form-group">
    						<label for="mdesc">Meta Description</label>
    						<textarea id="mdesc" name="mdesc" rows="5" class="form-control" cols="30" required> Meta Description Here</textarea>
    					</div>
                    </div>
                </div>
                    <!-- /.box-body -->
