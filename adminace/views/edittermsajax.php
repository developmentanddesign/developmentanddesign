...
?>
            <div class="box box-info">
              ...
              <!-- /.box-header -->
              <!-- form start -->
              <form id="update" action="ajax/termsajax.php" method="POST" enctype="multipart/form-data">
                <div class="box-body">
...
<?php }else{ ?>
        <div class="box box-info">
              ...
              <!-- /.box-header -->
              <!-- form start -->
              <form id="terms_form" action="ajax/aboutajax.php" method="POST" enctype="multipart/form-data">
                <div class="box-body">
                  <div id="result"><?php global $msg; echo $msg;?></div>
