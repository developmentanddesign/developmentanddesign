      ...
      <div class="col-xs-12">
          <div class="box box-info">
              <div class="box-header with-border">
                <h3 class="box-title">All Terms Page Entries <a href="addterms.php" title="Add New"><span class="btn btn-warning">Add New</a></span></h3>
              </div>
              <!-- /.box-header -->
                <div class="box-body">
                  <?Php global $msg; echo $msg;?>
                       ...
                       <?php 
                            ...
                            <tr>
                              ...
                              <td>  <a href="editterms.php?id=<?php echo $id; ?>">
            						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            						<button title="Edit" class="btn btn-success"><i class="fa fa-pencil-square-o"></i></button>
            						</a>
            						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp
            						<button title="Delete" id="<?php echo $id; ?>" class="btn btn-danger delete" data-href="allterms.php?del=" data-toggle="modal" data-target="#myModal"><i class="fa fa-times"></i></button></td>
                            </tr>
        				        <?php $sr++;}?>
